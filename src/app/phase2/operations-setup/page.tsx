...
import { ArrowLeft, Upload, Cog } from 'lucide-react';
            ...
            <div className="bg-[#1e4b5f] text-white">
                <div className="max-w-7xl mx-auto px-6 pt-6 pb-8">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-semibold tracking-wide">Operations Setup</h1>
                            <p className="text-white/50 text-sm font-light mt-0.5">Process workflows, SOPs &amp; operational readiness</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm">
                    <div className="bg-[#1e4b5f] px-7 py-5 rounded-t-xl">
                        <h2 className="font-semibold text-white text-base">Operations Setup</h2>
                    ...
                    <div className="flex flex-col items-center justify-center py-24 text-center px-8">
                        ...
                        <p className="text-slate-400 text-sm font-light max-w-sm">Process workflows, standard operating procedures and operational readiness checklists will be added here.</p>
                    </div>
                </div>
            </div>
        </div>
